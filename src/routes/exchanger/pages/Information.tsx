  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-100 dark:bg-gray-900 pt-20">
      <div className="max-w-3xl px-6 py-12 text-center">
        <div className="mb-8">
          <h1 className="mt-4 text-4xl font-serif font-bold tracking-tight text-gray-900 dark:text-gray-100">
            Caritas
          </h1>
        </div>
        <p className="mx-auto mb-8 w-full text-lg font-medium leading-relaxed text-gray-600 dark:text-gray-400">
        ...
        <h3 className="mt-4 text-2xl font-serif font-bold tracking-tight text-gray-900 dark:text-gray-100">
            Nuestras ubicaciones
          </h3>
          <Maps />
      </div>
      <footer className="mb-8 text-lg font-medium leading-relaxed text-gray-600 dark:text-gray-400">Para más información, contáctenos en: SoySolutions@gmail.com</footer>
    </div>
  );
};